...
public class PlayerBuildingScript : MonoBehaviour
{
    ...
    public bool amIInBuildingBarricade; //jeigu true - barricada, jeigu false - turret. Domas valdo sita boola
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                else if(amIInBuildingBarricade) //barikados statymas
                {
